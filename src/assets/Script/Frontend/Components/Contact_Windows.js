...
import Canal from "./Canal-Contact";
import {
  Consult_RPC,
  Company_CRUD,
  Search_A_Contact,
  UpdateDelete_Canal,
  Search_Contacts_Canal_All,
  Delete_A_Contact,
  Edit_Contact,
} from "../consult";
...
class Contact extends Component {
  ...
  async EliminarCanal(e) {
    ...
    if (ControlEditarcontacto) {
      ...
      let resultado = await UpdateDelete_Canal(Base);
  ...
  async componentDidMount() {
    ...
    if (this.props.ID !== "Agregar") {
      const ResultadoBuscar = await Search_A_Contact(BaseBody);
      ...
      const ResultadoCanal = await Search_Contacts_Canal_All(BaseBody);
  ...
  async GuardarContacto(e) {
    ...
    const result = await Edit_Contact(BaseBody);
  ...
  async UNSAFE_componentWillMount() {
    ...
    const Resultado = await Company_CRUD(Base);
    ...
    if (Resultado.estado === "Fallo") {
      ...
      const Resultados = await Company_CRUD(Base);
          ...
          <div className="Ventana_Contactos">
            <div className="contenedor-header">
              ...
              <div className="cierre">
                <a className="cierreetiqueta" href="/Contact">
